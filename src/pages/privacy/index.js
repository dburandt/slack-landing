  ...
  return (
    <>
      ...
      <div className="priv-container">
        <h1 className="h1-priv">Privacy Policy</h1>

        <p>Effective date: October 14, 2019</p>

        <p>
          Feedback Bill ("us", "we", or "our") operates the
          https://www.feedbackbill.com website and the Feedback Bill mobile
        ...
        <p>
          ...
          Feedback Bill has been created with the help of{" "}
          <a className="sub-link" href="https://www.termsfeed.com/">
            TermsFeed
          </a>
          .
        </p>
        ...
        <br />
        <h2 className="h2-priv">Definitions</h2>
        <ul>
          <li>
            <p>
              Service: Service means the https://www.feedbackbill.com website
              and the Feedback Bill mobile application operated by Feedback Bill
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              Cookies: Cookies are small files stored on your device (computer
              or mobile device).
            </p>
          </li>
        </ul>
        <br />
        <h2 className="h2-priv">Information Collection and Use</h2>
        <p>
        ...
        <br />
        <h2 className="h2-priv">Use of Data</h2>

        <p>Feedback Bill uses the collected data for various purposes:</p>
        <ul>
        ...
        <br />
        <h2 className="h2-priv">Transfer Of Data</h2>
        <p>
        ...
        <p>
          Feedback Bill will take all steps reasonably necessary to ensure that
        ...
        <p>
          Feedback Bill may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Feedback Bill</li>
          <li>
        ...
        <br />
        <h2 className="h2-priv">Security of Data</h2>
        <p>
        ...
        <br />
        <h2 className="h2-priv">Service Providers</h2>
        <p>
        ...
        <h2 className="h2-priv">Links to Other Sites</h2>
        <p>
        ...
        <h2 className="h2-priv">Children's Privacy</h2>
        <p>
        ...
        <h2 className="h2-priv">Changes to This Privacy Policy</h2>
        <p>
        ...
        <br />
        <h2 className="h2-priv">Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, please contact
          us:
        </p>
        <ul>
          <li>By email: contactfeedbackbill@gmail.com</li>
        </ul>
      </div>
    </>
  );
